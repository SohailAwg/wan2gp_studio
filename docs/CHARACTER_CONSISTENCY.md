# Character Consistency in WanGP
...
2. Keep a short locked identity description and repeat it every shot.
3. Use reference-aware models or trained identity assets rather than prompt-only generation.
4. For long stories, split into short shots and re-anchor the identity each shot.
5. Keep lighting/style language stable unless the shot intentionally changes it.
...
2. Add a character name and locked identity prompt.
